...
echo "    lsfs-parity"
echo ""
echo "  Install Sublime Text 4:"
echo "    yay -S sublime-text-4"
echo "    # Or manual: https://www.sublimetext.com/download"
echo ""
echo "  Time-based queries (now supported):"
echo "    lsfs-query --list-mode 'files from last 42h'"
echo "    lsfs-query --list-mode 'config changed last 3 days'"
echo "    lsfs-query --list-mode 'recent 24h ext:py'"
echo ""
